...
def sim_study(iterations):
    ...
    for i in range(iterations):
        ...
        results = order_policy_eval(mod="EOQ", audit_frequency=audit_choice,
    ...
    total_results.to_excel("Results_Excel/" + "EOQ" + "_" + "RS" + ".xlsx", sheet_name="Results")


start_proc = time.process_time()

run = sim_study(iterations=50)
